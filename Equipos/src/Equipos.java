...
public class Equipos extends JFrame {
	...
	private ControllerDB conect=new ControllerDB();
	
	JComboBox<String> listadoEquipos;
	...
	public Equipos() {
		...
		inicializarVentana();
		conect.leerEquipos(listadoEquipos);
	}
	...
	private void inicializarVentana(){
		...
		listadoEquipos = new JComboBox<String>();
		...
		btnGuardarEquipoEn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				conect.insertarEquipos(1, nombreEquipo.getText(), Integer.valueOf(golesFavor.getText()), Integer.valueOf(golesEnContra.getText()), Integer.valueOf(partidosGanados.getText()), Integer.valueOf(partidosPerdidos.getText()), listadoEquipos);
			}
		});
